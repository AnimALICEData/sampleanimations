...
The clips below are sorted by type of collision, which refers to either Pb-Pb collisions (Lead ions) or p-p collisions (protons); and multiplicity, which is the number of particles in the event.
